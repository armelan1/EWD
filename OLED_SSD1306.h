...
#ifndef NO_OLED_SSD1306_COLOR_COMPATIBILITY
...
class OLED_SSD1306 : public Adafruit_GFX {
 public:
  ...
  OLED_SSD1306(uint8_t w, uint8_t h, TwoWire *twi=&Wire, int8_t rst_pin=-1,
    uint32_t clkDuring=400000UL, uint32_t clkAfter=100000UL);
  OLED_SSD1306(uint8_t w, uint8_t h, int8_t mosi_pin, int8_t sclk_pin,
    int8_t dc_pin, int8_t rst_pin, int8_t cs_pin);
  OLED_SSD1306(uint8_t w, uint8_t h, SPIClass *spi,
